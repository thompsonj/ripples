...
//var sub = "s03";
var sub = "s06";
var DataPath = "/Users/jthompson/data/ripples/"+ sub + "/images/";
...
//	if( !ret ) return;
	...
	// align to first volume of AP (1), 
	//Parameter 3: Interpolation method: 0 and 1: trilinear detection and trilinear interpolation, 2: trilinear detection and sinc interpolation or 3: sinc detection of motion and sinc interpolation.trilinear (2) sinc interpolation (3), use full dataset, 100 max iterations, generate movie, generate log file
	docFMR.CorrectMotionTargetVolumeInOtherRunEx(targetFMR, 1, 2, 1, 100, 1, 1);
