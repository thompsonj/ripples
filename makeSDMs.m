function makeSDMs(HRF, minus, dim, scaled, MC, subs)
...
%    minus - 1 to use minus predictors or no (e.g. f01-f02), 0 for just f01
%    dim - Current options: 4 or 13 (could add 3 maybe 6)
...
%    makeSDMs(2, 1, 4, 1, 0, {'s01','s02', 's03', 's04', 's05', 's05'})
%    makeSDMs(1, 1, 4, 1, 1, {'s01','s02', 's03', 's04', 's05', 's05'})
%
...
if strfind(os, 'Windows')
    ...
    datadir = '/Users/jthompson/data/ripples/';
end
